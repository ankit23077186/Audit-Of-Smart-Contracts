...
/// @dev Be cautious of potential vulnerabilities in the pickWinner function, including reentrancy and predictable randomness.
...
contract Lottery {
    ...
    /// @dev Players must send more than 0.1 ether to enter the lottery.

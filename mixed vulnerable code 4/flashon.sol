...
//The vulnerability existed in the vesting03 contract in the createVestForDeposit() function.
// This function is responsible for storing initial information regarding user deposit and minting the vestID.

//However, this function didn’t update the vestRewardPerTokenPaid[vestID] with the current rewardPerToken,
// which should actually be very low after an immediate deposit because not enough time 
//has passed for the user to earn their full token reward. So, the _earned() function in the withdraw()
